                ...
                >
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      width: "100%",
                      height:
                        hoveredIndex === index && !isMobile ? "auto" : "100%",
                      minHeight:
                        hoveredIndex === index && !isMobile
                          ? { xs: "280px", sm: "320px", md: "350px" }
                          : "auto",
                      display: "flex",
                      flexDirection: "column",
                      ...
                      zIndex: hoveredIndex === index && !isMobile ? 10 : 1,
                      cursor: "pointer",
                      transition:
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        mt: "auto",
                        pt: hoveredIndex === index && !isMobile ? 1 : 0,
                      }}
                    >
                      {/* Wrapper for bottom content (buttons) */}
                      {!isMobile && hoveredIndex === index && project.repo && (
                        <Button
                          component="a"
                          href={project.repo}
                          target="_blank"
                      ...
                      {isMobile && (
                        <Button
                          ...
                          variant="contained"
                          size="small"
                          sx={{ ...buttonStyle, fontSize: "0.8rem" }}
                        >
                          View Details
                        </Button>
                      )}
