...
export default function useCustomTheme() {
  ...
  const theme = React.useMemo(() => {
    return createTheme({
      ...
      palette: {
        ...
        background: {
          default: effectiveTheme === 'dark' ? '#121212' : '#f5f5f5',
          paper: effectiveTheme === 'dark' ? '#1e1e1e' : '#f2f4f7',
        },
        threejsback: {
          default: effectiveTheme === 'dark' ? '#0b0d17' : '#412d5c',
        },
        contrastThreshold: 3,
        tonalOffset: 0.2,
      },
  ...
  }, [handleSelectTheme, storedTheme, effectiveTheme]);
